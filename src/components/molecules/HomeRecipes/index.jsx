...
return (
    <><header className="HomeRecipes__info">
        ...
        <div className="HomeRecipes__slider__arrows">
            <button className="leftArrow" onClick={leftArrowClickHandler} disabled={isScrolling} ><img src={leftarrow}></img></button> 
            <button className="rightArrow" onClick={rightArrowClickHandler} disabled={isScrolling} ><img src={rightarrow}></img></button>
            </div>
            </>
)
}
